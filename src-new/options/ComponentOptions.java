 ...
 * 
 * @param <OptionsType>
 *            tells what kind of options we create and handle components for
 */
public abstract class ComponentOptions<OptionsType extends Options<OptionsType>> {
	 ...
	 * <b>Warning!!<b> Setting options cannot be done by invoking setOptions
	 * method, because ServerComponentOptions overrides setOptions method to
	 * invoke his own LevelComponentOptions method too, but at the time when
	 * this constructor is invoked, that object cannot be existed,
	 * NullPointerException would be thrown. Based on the object hierarchy, this
	 * anomaly cannot be solved in other ways.<br>
	 * 
	 * @param options
	...
	/**
	 * Creates a new options object, stores into that the actual states of the
	 * option components, and returns it.
	 * 
	 * @return the Options object holding the values/states of the option
	 *         components
	 */
	 ...
	 * The returned tabbed pane is for displaying in the appropriate options
	 * dialog, where viewing/changing the values of the options can be done.
	 * 
	...
	/**
	 * Returns the options object which is being handled by the implementer
	 * class.<br>
	 * 
	 ...
	 * 
	 * @param text
	 *            the text of the creatable JLabel
	 * @param enabled
	 *            tells whether the creatable JLabel object have to be enabled
