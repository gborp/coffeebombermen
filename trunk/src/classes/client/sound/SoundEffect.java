...
public enum SoundEffect {
	BOOM("boom"), PICKUP("pickup"), WOUND("wound"), KICK("kick"), HEAL("heal"), THROW(
			"throw"), DIE("die"), PLACE_BOMB("placebomb"), START_MATCH(
			"startmatch"), DEATH_WALL("deathwall"), PLACE_WALL("placewall");
	 ...
	 * @param soundDirName
	 * @param roundRobin
	 *  Some sounds like wall are not cool when changing. Some like wound are cool.
	 */
	...
	private void addClips(){
		...
		String[] fileNames = GeneralUtilities
				.getFileNames(path);
