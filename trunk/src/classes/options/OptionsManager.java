 ...
 * options object must be passed to the constructor.
 * 
 * @param <OptionsType>
 *            tells what kind of options is managed by this manager
 * @author Andras Belicza
 */
public class OptionsManager<OptionsType extends Options<OptionsType>>
	...
	private final List<OptionsChangeListener<OptionsType>> optionsChangeListeners = new ArrayList<OptionsChangeListener<OptionsType>>();
	 ...
	 *            component options to be managed
	 * @param optionsDialogTitle
	 *            title of the options dialog
	 * @param mainFrame
	 *            reference to the main frame
	 */
	public OptionsManager(final ComponentOptions<OptionsType> componentOptions,
			final String optionsDialogTitle, final JFrame mainFrame) {
	...
	public OptionsManager(final ComponentOptions<OptionsType> componentOptions,
		...
		final String[] buttonLabels = { OK_BUTTON_LABEL,
				RESTORE_DEFAULTS_BUTTON_LABEL, CANCEL_BUTTON_LABEL };
		final String[] buttonLabelsWhenViewOnly = { OK_BUTTON_LABEL };
		for (final String buttonLabel : this.viewOnly ? buttonLabelsWhenViewOnly
				: buttonLabels) {
	...
	/**
	 * Shows the options dialog where the options will be displayed and become
	 * modifiable.
	 */
	public void showOptionsDialog() {
		...
		optionsDialog.getContentPane().add(
				new JScrollPane(componentOptions.getOptionsTabbedPane()),
				BorderLayout.CENTER);
	...
	public void actionPerformed(final ActionEvent ae) {
		...
		if (actionCommand.equals(OK_BUTTON_LABEL)) {
			...
			componentOptions.setOptions(componentOptions
					.getOptionsFromComponents());
	 ...
	 * 
	 * @param optionsChangeListener
	 *            options change listener to be registered
	 */
	public void registerOptionsChangeListener(
			final OptionsChangeListener<OptionsType> optionsChangeListener) {
	 ...
	 * 
	 * @param optionsChangeListener
	 *            options change listener to be unregistered
	 */
	public void unregisterOptionsChangeListener(
			final OptionsChangeListener<OptionsType> optionsChangeListener) {
