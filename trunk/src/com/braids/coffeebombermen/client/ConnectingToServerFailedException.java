 ...
 * This exception occurs on the client side when a client tries to connect to a
 * Bombermen server, but fails.<br>
 * (Some) possible causes: host not found, host does not run Bombermen server,
 * server is locked, passwords does not match...
 */
