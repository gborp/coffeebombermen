...
public class ClientComponentOptions extends ComponentOptions<ClientOptions> implements ActionListener {
	...
	/*
	 * Static initializer to initialize DEFAULT_PLAYER_NAMES and
	...
	private final JSpinner                      playersFromHost_c                       = new JSpinner(new SpinnerNumberModel(DEFAULT_PLAYERS_FROM_HOST,
	                                                                                            MINIMUM_PLAYERS_FROM_HOST, MAXIMUM_PLAYERS_FROM_HOST, 1));
	 ...
	 * 
	 * @param clientOptions
	 *            the client options object to be handled
	 */
	...
	/**
	 * Restores the default values of the client options to the option
	 * components.
	 */
	...
	/**
	 * Creates a new client options object, stores into that the actual states
	 * of the option components, and returns it.
	 * 
	 * @return the ClientOptions object holding the values/states of the option
	 *         components
	 */
	...
	/**
	 * Stores the values of the client option attributes to the appropriate
	 * components.
	 */
	...
	/**
	 * Handles the action events of the button components of players control
	 * keys. Makes a new dialog, and handles pressed key as the new key for the
	 * selected action.
	 * 
	 * @param ae
