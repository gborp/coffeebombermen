...
public class GeneralUtilities {
	 ...
	 * @param toWindow
	 *            window where to be center the other window
	 */
	public static void centerWindowToWindow(final Window window, final Window toWindow) {
		...
		window.setLocation(Math.max(Math.min(toWindowBounds.x + (toWindowBounds.width - window.getWidth()) / 2, displayBounds.x + displayBounds.width
		        - window.getWidth()), 0), Math.max(Math.min(toWindowBounds.y + (toWindowBounds.height - window.getHeight()) / 2, displayBounds.y
		        + displayBounds.height - window.getHeight()), 0));
	}
	 ...
	 * 
	 * @param directoryName
	 *            the name of directory where to search for subdirectoires
	 *            within
	 ...
	 * 
	 * @param directoryName
	 *            name of directory where to search for files
	 * @param extension
	...
	/**
	 * Creates and returns a buffered image which is compatible with the default
	 * display. Can be used to create buffered images for high performance.
	 * 
	 * @param width
	 *            width of the createable buffered image
	 * @param height
	 *            height of the createable buffered image
	 * @param opaque
	 *            tells whether the createable buffered image should be (is)
	 *            opaque
	 * @return a buffered image with the specified properties whic is compatible
	 ...
	 * The 2 rectanges are specified with coordinates of their left top and
	 * right bottom points.
	 * 
	 * @param x11
	 *            x coordinate of the left top point of the first rectangle
	 * @param y11
	 *            y coordinate of the left top point of the first rectangle
	 * @param x12
	 *            x coordinate of the right bottom point of the first rectangle
	 * @param y12
	 *            y coordinate of the right bottom point of the first rectangle
	 * @param x21
	 *            x coordinate of the left top point of the second rectangle
	 * @param y21
	 *            y coordinate of the left top point of the second rectangle
	 * @param x22
	 *            x coordinate of the right bottom point of the second rectangle
	 * @param y22
	 *            y coordinate of the right bottom point of the second rectangle
	 ...
	 * Returns a number between 0 and weights.length chosen randomly based on
	 * the weigths table using the specified random object.
	 * 
	 * @param weights
	 *            weights table to based the decision on
	 * @param random
	 *            random object to be used for the random decision
