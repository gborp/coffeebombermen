...
public interface ModelProvider {
	 ...
	 */
	List<PlayerModel[]> getClientsPlayerModels();
	 ...
	 */
	List<PublicClientOptions> getClientsPublicClientOptions();
	 ...
	 * one that hangs down into that component.
	 * 
	 * @param componentPosX
	 *            x coordinate of the component
	 * @param componentPosY
	 ...
	 *            model of player to be excluded
