...
public class Consts {
	...
	public enum PlayerColors {
		...
		/**
		 * Overrides toString() method for displaying the names of the colors in
		 * the color choosing list in client options dialog.
		 * 
	...
	/**
	 * The Map of items which neutralize others. The key object is the
	 * neutralizer item, the value object is the set of the neutralized items.
	 */
	public static final EnumMap<Items, EnumSet<Items>> NEUTRALIZER_ITEMS_MAP = new EnumMap<Items, EnumSet<Items>>(Items.class);
	...
	public enum KillsBelongTos {
		...
		OWNER_OF_KILLER_BOMB {

			public String toString() {
				return "the owner of killer bomb";
			}
		},
		/** Kills belong to the owner of triggerer bomb. */
		OWNER_OF_TRIGGERER_BOMB {

			public String toString() {
				return "the owner of triggerer bomb";
			}
		}
	}
