...
public class PositionedIterableObject extends IterableObject {
	...
	/**
	 * Returns the x coordinate of the level component where the position
	 * belongs to
	 * 
	 * @return the x coordinate of the level component where the position
	 *         belongs to
	 */
	 ...
	 * 
	 * @param posX
	 *            the x coordinate of the position to be set
	 */
	...
	/**
	 * Returns the y coordinate of the level component where the position
	 * belongs to
	 * 
	 * @return the y coordinate of the level component where the position
	 *         belongs to
	 */
	 ...
	 * of the direction, and can be used to calculate positions ahead of the
	 * object (in the current direction).
	 * 
	 * @return an integer identifying the horizontal component of the direction:<br>
	 *         -1, if direction is Directions.LEFT, 1, if direction is
	 *         Directions.RIGHT 0 otherwise
	 */
	 ...
	 *         -1, if direction is Directions.UP, 1, if direction is
	 *         Directions.DOWN 0 otherwise
	 */
