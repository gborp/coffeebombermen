...
public abstract class AbstractAnimationMainComponentHandler implements MainComponentHandler {
	...
	/**
	 * Returns the new animation datas for the animation component being the
	 * main component.<br>
	 * Called by the graphicalThemeChanged() method to gain the new animation
	 * datas.<br>
	 * Implementation simply should be: return
	 * GraphicsManager.getCurrentManager().getXxxAnimationDatas();
	 * 
	...
	/**
	 * Creates a new animation component, if a curren graphical manager exists,
	...
	/**
	 * Called when handler of main component is being replaced, so main
